        ...
        <div class="row">
            <div class="col-md-12 main m-auto">
                <div class="cars">
                    ...
                    <form action="/updatevehicle/{{$updateData->id}}"  method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                           ...
                           <div class="col-md-6 mb-3">
                            <input type="hidden" name="_method" value="put">
                                ...
                                <input type="text" placeholder="" class="form-control" value="{{$updateData->name}}" name="name">
                                <p style="color: red">@error('name'){{$message}} @enderror</p>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="">Email</label>
                                <input type="email" placeholder="" class="form-control" value="{{$updateData->email}}" name="email">
                                <p style="color: red">@error('email'){{$message}} @enderror</p>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="">Password</label>
                                <input type="password" placeholder="" class="form-control" value="{{$updateData->password}}" name="password">
                                <p style="color: red">@error('password'){{$message}} @enderror</p>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="">Car Brand</label>
                                <input type="text" placeholder="" class="form-control" value="{{$updateData->brand}}" name="brand">
                                <p style="color: red">@error('brand'){{$message}} @enderror</p>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="">Car Model</label>
                                <input type="text" placeholder="" class="form-control" value="{{$updateData->model}}" name="model">
                                <p style="color: red">@error('model'){{$message}} @enderror</p>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="">Top Speed</label>
                                <input type="text" placeholder="" class="form-control" value="{{$updateData->speed}}" name="speed">
                                <p style="color: red">@error('speed'){{$message}}  @enderror</p>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="">Horsepower</label>
                                <input type="text" placeholder="" class="form-control" value="{{$updateData->horsepower}}" name="horsepower">
                                <p style="color: red">@error('horsepower'){{$message}}  @enderror</p>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="">Torque</label>
                                <input type="text" placeholder="" class="form-control" value="{{$updateData->torque}}" name="torque">
